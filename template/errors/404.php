...
<html lang="en">
    <head>
        ...
        <!--[if lte IE 9]>
                <link rel="stylesheet" href="<?= BASE_URL ?>template/css/ace-part2.min.css" class="ace-main-stylesheet" />
        <![endif]-->
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="error-container">
                                    <div class="well">
                                        ...
                                        <div>
                                            Ingrese a una ruta valida por el sistema, haciendo uso del menu de opciones y siguendo las opciones dentro del sistema
                                        </div>
                                        <hr />
